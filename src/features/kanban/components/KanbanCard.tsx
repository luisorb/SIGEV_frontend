...
import { GripVertical, Hash, User, Building2, DollarSign, Layers } from 'lucide-react'
...
export function KanbanCard({ card, aliadoNombre, municipioNombre }: KanbanCardProps) {
      ...
      <div className="flex items-start justify-between gap-2">
        <div className="flex items-center gap-2 min-w-0">
          <button
            {...attributes}
            {...listeners}
            className="p-0.5 rounded hover:bg-slate-100 cursor-grab active:cursor-grabbing shrink-0"
